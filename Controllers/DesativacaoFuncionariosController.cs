...
namespace BlurayDreamsAPI.Controllers
{
    ...
    public class DesativacaoFuncionariosController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutDesativacaoFuncionario(int id, DesativacaoFuncionario desativacaoFuncionario)
        {
            ...
            _context.Entry(desativacaoFuncionario).State = EntityState.Modified;
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<DesativacaoFuncionario>> PostDesativacaoFuncionario(DesativacaoFuncionario desativacaoFuncionario)
        {
            _context.DesativacaoFuncionarios.Add(desativacaoFuncionario);
            await _context.SaveChangesAsync();
